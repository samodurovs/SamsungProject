...
import static com.samsung_proj.SITSproj.Preferences.BOUNDARIES;
import static com.samsung_proj.SITSproj.Preferences.LEVELS;
...
public class LessonsLDH extends Dao {
    ...
    public static LessonsLDH getInstance(Context context){
        if(instance == null){
            instance = new LessonsLDH(context);
        }
        return instance;
    }
    @Override
